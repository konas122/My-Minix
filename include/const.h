#ifndef	_KONIX_CONST_H_
#define	_KONIX_CONST_H_
...
#define	MAX_DRIVES		    2                           // 2块硬盘
#define	NR_PART_PER_DRIVE	4
#define	NR_SUB_PER_PART		16                          // 定义了每个扩展分区最多有多少个逻辑分区
...
#define KONIX_PART	0x99	    /* Konix'S partition */
